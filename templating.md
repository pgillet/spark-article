...
But as we want to automate a maximum of things, and we want to operate Kubernetes from Python code (Yes, we do! Oh, my
 god, what a plot twist! See the following section), we cannot use such a tool.
